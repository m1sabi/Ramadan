...
async function updateTable() {
  ...
  const todayDate = new Date(2025, 3, day);
  ...
  if (typeof highLatCities !== "undefined" && highLatCities.includes(city)) {
    ...
    if (makkahDayData && makkahFajrData) {
      const makkahFastMin = timeToMinutes(makkahDayData.sunset) - timeToMinutes(makkahFajrData.Fajr);
